...
- **학습 현황**: Prompt Evaluation, Prompt Engineering Techniques 섹션 완료.
  Tool Use with Claude 섹션 진행 중 (도구 정의·schema·tool use 루프·멀티턴 구현까지 완료).
...
실습 파일명 규칙: `실습{실습순번}_{챕터약칭}_{강의번호}_{강의제목}`
예) `실습002_tools_007_Multi-turn_conversations_with_tools.ipynb`
→ 해당 챕터 내 두 번째 실습 / 강의 7번 / 강의 제목 Multi-turn conversations with tools
...
└── 004. Tool use with Claude/              ← 도구 정의, schema, tool use 루프, 실습 #1~3
